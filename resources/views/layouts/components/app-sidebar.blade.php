    ...
    <aside class="app-sidebar">
        <div class="main-sidebar-header active">
            <a class="header-logo active" href="{{ url('/') }}">
                <img style="max-height: 40px !important" src="" class="main-logo" alt="Rokia">
            </a>
        </div>
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                @if (authUserHasPermission('list_therapists') ||
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            @endif
                            @if (authUserHasPermission('list_lectures'))
                                <li>
                ...
                @if (authUserHasPermission('list_slider') ||
                        authUserHasPermission('create_slider') ||
                        authUserHasPermission('list_rozmana'))
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a class="slide-item"
                                    data-is_active="{{ request()->fullUrlIs(route('clients.index')) }}"
                                    href="{{ route('clients.index') }}">@lang('app.clients.clients')</a></li>
                        </ul>
                    </li>
                @endif

                @if (authUserHasPermission('list_users') || authUserHasPermission('list_invoices'))
                    ...
                    @endif
                @endif
                @if (authUserHasPermission('list_appointment') || authUserHasPermission('list_invoices'))
                    <li class="side-item side-item-category">@lang('app.therapist_accounting')</li>
                    @if (authUserHasPermission('list_invoices'))
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                    ...
                    @endif
                    @if (authUserHasPermission('list_appointment'))
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
                ...
                @endif
                @if (authUserHasPermission('show_setting'))
