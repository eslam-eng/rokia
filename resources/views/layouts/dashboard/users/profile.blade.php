...
@section('content')
    ...
    <div class="main-container container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="card-body d-md-flex">
                        <div class="">
                            <span class="profile-image pos-relative">
                                ...
                                <span class="bg-success text-white wd-1 ht-1 rounded-pill {{ Auth::user()->status ? "profile-online": "profile-offline"}}"></span>
                            </span>
                        </div>
                        <div class="my-md-auto mt-4 prof-details">
                            ...
                            <p class="tx-13 text-muted ms-md-4 ms-0 mb-2 pb-2 ">
                                <span class="me-3"><i class="far fa-address-card me-2"></i>{{ App\Enums\UsersType::from(Auth::user()->type)->name }}</span>
                                <span class="me-3"><i class="fa fa-taxi me-2"></i>{{ Auth::user()->city->title }}</span>
                                <span><i class="far fa-flag me-2"></i>{{ Auth::user()->area->title }}</span>
                            </p>
                        ...
                        <div class="card-footer py-0">
                            <div class="profile-tab tab-menu-heading border-bottom-0">
                                <nav class="nav main-nav-line p-0 tabs-menu profile-nav-line border-0 br-5 mb-0	">
                                    ...
                                    <a class="nav-link mb-2 mt-2" data-bs-toggle="tab" href="#settings">Account Settings</a> --}}
                                </nav>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Row -->
            <div class="row row-sm"> <div class="col-lg-12 col-md-12">
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ route('profile.update', Auth::user()->id) }}"> 
                                        ...
                                        <div class="form-group ">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="numeric" name="phone" class="form-control" value="{{ Auth::user()->phone }}">
                                                    @error('phone')
                                                        <div class="text-danger"> {{$message}}</div>
                                                    @enderror
                                                </div>
